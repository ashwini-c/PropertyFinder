...
public class PropertyListFragment extends ListFragment {
	...
	public Property updateProperty(Property property) {
		for (int i = 0; i < properties.size(); i++) {
			Property p = properties.get(i);
			if (p.ListingID == property.ListingID) {
				properties.get(i).Body = property.Body;
				properties.get(i).photo_thumb_urls.clear();
				properties.get(i).photo_thumb_urls.addAll(property.photo_thumb_urls);
				properties.get(i).photo_large_urls.clear();
				properties.get(i).photo_large_urls.addAll(property.photo_large_urls);
