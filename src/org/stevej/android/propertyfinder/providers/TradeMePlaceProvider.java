...
public class TradeMePlaceProvider extends ContentProvider {
	...
	public boolean onCreate() {
		...
		uri_matcher.addURI("org.stevej.android.propertyfinder.providers.TradeMePlaceProvider", "places/#", GET_PLACE);
		uri_matcher.addURI("org.stevej.android.propertyfinder.providers.TradeMePlaceProvider", "search_suggest_query", SEARCH_SUGGEST);
